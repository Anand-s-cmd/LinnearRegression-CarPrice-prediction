...
# loading the data
ToyotaCorolla = pd.read_csv("C:\\NOTES WRITTEN\\SOLVING_ASSIGNMENTS\\multiliear regression\\NEW_SET\\ToyotaCorolla.csv", usecols = ["Price","Age_08_04","KM","HP","cc","Doors","Gears","Quarterly_Tax","Weight"])
type(ToyotaCorolla)
